# Source: https://github.com/MicrosoftDocs/Virtualization-Documentation/blob/82a6a47b44d2f9eb1936acbd01d133b9531ab8af/windows-server-container-tools/Debug-ContainerHost/Debug-ContainerHost.ps1
